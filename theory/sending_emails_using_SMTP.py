...
sender = 'mishraprasant73@gmail.com'
receivers = ['mishraprasant73@gmail.com']

message = """From: From Person <prasant@apnetruck.com>
To: To Person mishraprasant73@gmail.com
...
# Following is the example, which sends a file /tmp/test.txt as an attachment. 
